...
export async function medicalAssistantChat(
  message: string,
    ...
    contents: [
      {
        ...
        parts: [
          {
            text: "Tu es un assistant médical qualifié. Tu réponds aux questions de santé de manière précise, empathique et sécurisée. Rappelle toujours à l'utilisateur de consulter un vrai médecin pour un diagnostic définitif.",
          },
        ],
      },
      ...history.map(h => ({

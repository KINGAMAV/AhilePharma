  ...
  <div className="p-8 space-y-8 bg-[#F0F4F8] min-h-full">
    ...
    <div className="grid grid-cols-2 gap-6">
      {[
        ...
        { label: 'Commandes', val: '845', icon: ShoppingBag, color: 'bg-purple-50 text-purple-600' },
        ...
        <div key={i} className="card-minimal p-6 flex flex-col items-center text-center">
           <div className={`w-14 h-14 rounded-2xl ${s.color} flex items-center justify-center mb-4 shadow-sm font-bold`}>
              <s.icon size={28} />
           </div>
        ...
        {[1, 2, 3].map(i => (
          <div key={i} className="flex items-center justify-between py-2 border-b border-slate-50 last:border-0">
             <div className="flex items-center gap-3">
               ...
               <span className="text-sm font-medium text-slate-600 italic">Mise à jour système API Gateway</span>
             </div>
...
const PharmacyDashboard = () => (
  <div className="p-8 space-y-8 bg-[#F0F4F8] min-h-full">
    ...
    <div className="bg-white p-8 rounded-[2.5rem] shadow-clean border border-slate-100 flex items-center justify-between">
      <div>
        <p className="text-slate-400 font-bold text-[10px] uppercase tracking-widest mb-1">Chiffre d'affaires (Jour)</p>
        ...
        <div key={i} className="card-minimal p-5 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-medium">3 articles • Patient: P. Amavi</p>
            </div>
          </div>
          <motion.button whileTap={{ scale: 0.95 }} className="px-5 py-2 bg-primary text-white font-bold text-[10px] rounded-xl shadow-md shadow-primary/20 uppercase tracking-wider">
            Préparer
          </motion.button>
        </div>
      ))}
...
const DeliveryDashboard = () => (
  <div className="p-8 space-y-8 bg-[#F0F4F8] min-h-full">
    ...
    <div className="relative h-56 rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white mb-8">
       <img src="https://images.unsplash.com/photo-1524661135-423995f22d0b?w=800&q=80" className="w-full h-full object-cover grayscale-[20%] opacity-80" alt="Map" />
       <div className="absolute inset-0 bg-primary/10" />
       <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
          <motion.div animate={{ scale: [1, 1.2, 1] }} transition={{ repeat: Infinity, duration: 2 }} className="w-10 h-10 bg-primary rounded-full border-4 border-white shadow-2xl flex items-center justify-center text-white">
            <Truck size={16} />
          </motion.div>
          <div className="mt-2 bg-white px-3 py-1 rounded-full text-[10px] font-bold shadow-md">Votre position</div>
       </div>
    </div>
    ...
    <div className="card-minimal p-8 space-y-8 relative overflow-hidden">
       <div className="flex items-center justify-between">
          ...
          <span className="px-3 py-1 bg-[#EEF2FF] text-[#4F46E5] rounded-full text-[10px] font-bold uppercase tracking-widest border border-[#E0E7FF]">Prioritaire</span>
       </div>
       <div className="flex gap-6">
          <div className="flex flex-col items-center space-y-2">
             <div className="w-10 h-10 rounded-xl bg-teal-50 text-[#2AC1C8] flex items-center justify-center shadow-sm"><Pill size={20} /></div>
             <div className="h-10 w-0.5 bg-slate-100 rounded-full" />
             <div className="w-10 h-10 rounded-xl bg-blue-50 text-[#1D9BF0] flex items-center justify-center shadow-sm"><MapPin size={20} /></div>
          </div>
          <div className="flex-1 space-y-6">
             <div>
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">Point de collecte</p>
                <p className="font-bold text-slate-800 italic">Pharmacie du Centre</p>
             </div>
             <div>
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">Destinataire</p>
  ...
  <div className="p-8 space-y-8 bg-[#F0F4F8] min-h-full">
    ...
    <div className="grid grid-cols-2 gap-4">
      <div className="card-minimal p-6 bg-white">
        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">Rdv Aujourd'hui</p>
        <p className="text-3xl font-display font-bold text-[#1D9BF0]">08</p>
      </div>
      <div className="card-minimal p-6 bg-white">
        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">Nouveaux Messages</p>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-[10px] text-slate-400 font-bold tracking-widest uppercase">14:30 - Consultation</p>
              </div>
            </div>
          </div>
          <button className="text-[#1D9BF0] font-bold text-[10px] border border-blue-100 px-3 py-1.5 rounded-lg uppercase">Détails</button>
        </div>
      ))}
    </div>
  </div>
        ...
        <Route index element={
          <div className="p-8 space-y-6">
            ...
            <div className="grid gap-4">
              {[
                { name: 'Administration', to: 'admin', icon: LayoutDashboard, color: 'bg-medical-dark' },
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className={`w-14 h-14 rounded-2xl ${d.color} text-white flex items-center justify-center shadow-lg`}>
                      <d.icon size={28} />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-slate-800">{d.name}</h3>
                      <p className="text-xs text-slate-400 font-medium tracking-tight">Accéder à votre espace professionnel</p>
                    </div>
                  </div>

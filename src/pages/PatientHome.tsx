...
const QuickAction = ({
  ...
  >
    ...
    <span className="text-[10px] font-bold text-slate-800 text-center leading-tight uppercase tracking-tighter">
      {label}
    </span>
  </motion.button>
);
    ...
    <div className="bg-[#F0F4F8] min-h-full pb-24">
      ...
      <div className="p-8 pb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <img
              src="https://ui-avatars.com/api/?name=Patrick+Amavi&background=2AC1C8&color=fff"
              alt="Profile"
            />
          </motion.button>
        </div>
      ...
      <div className="px-8 mt-8">
        <div className="bg-medical-dark p-8 rounded-[2.5rem] text-white relative overflow-hidden shadow-2xl shadow-medical-dark/20">
          <div className="relative z-10 w-2/3 space-y-4">
            <span className="bg-[#00B894] px-2 py-1 rounded text-[10px] font-bold tracking-widest uppercase">
              Offre Limitée
            </span>
          ...
          <Building2
            size={160}
            className="absolute -right-16 -bottom-10 opacity-10 pointer-events-none rotate-12"
          />
        </div>
      </div>
      ...
      <div className="mt-10 px-8 pb-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <button onClick={() => navigate('/clinics')} className="text-sm font-bold text-primary">
            Tout voir
          </button>
        </div>
